...
import org.wlyyy.itrs.exception.StorageException;
import org.wlyyy.itrs.exception.StorageFileNotFoundException;
import org.wlyyy.itrs.properties.StorageProperties;
...
public class StorageFileSystemService implements StorageService {
    ...
    public String store(MultipartFile file) {
        ...
        try {
            ...
            Files.copy(file.getInputStream(), this.rootLocation.resolve(generatedFileName));
        } catch (IOException e) {
