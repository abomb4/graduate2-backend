 ...
 * @author wly
 */
public class DemandApplyFlowListItemVo {
     ...
     * @param getApplyFlowListById  根据招聘需求id获取其下的招聘流程们
     * @return 视图VO对象
     */
    public static DemandApplyFlowListItemVo buildFromDomain(
            Demand source,
            ...
            Function<Long, List<ApplyFlowSimpleListItemVo>> getApplyFlowListById
    ) {
        ...
        final List<ApplyFlowSimpleListItemVo> applyFlowList = getApplyFlowListById.apply(source.getId());
        final String gmtCreate = formatter.format(source.getGmtCreate());
        final String gmtModify = formatter.format(source.getGmtModify());

        return new DemandApplyFlowListItemVo(
                id,
                demandNo,
                publisherId,
                publisherName,
    ...
    public DemandApplyFlowListItemVo() {
    }

    public DemandApplyFlowListItemVo(
            Long id, String demandNo, Long publisherId, String publisherName, Long positionType, String positionTypeCnName,
            String jobName, Long departmentId, String departmentName, String hrName, Long total, String workingPlace,
            String degreeRequest, Integer status, String statusName, String memo, List<ApplyFlowSimpleListItemVo> applyFlowList,
    ...
    private String memo;
    private List<ApplyFlowSimpleListItemVo> applyFlowList;
    ...
    public List<ApplyFlowSimpleListItemVo> getApplyFlowList() {
        return applyFlowList;
    }

    public void setApplyFlowList(List<ApplyFlowSimpleListItemVo> applyFlowList) {
        this.applyFlowList = applyFlowList;
    }
